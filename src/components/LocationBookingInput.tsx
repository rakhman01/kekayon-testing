...
const LocationBoookingInput: FC<LocationInputProps> = ({
    autoFocus = false,
    onInputDone,
    ...
    return (
        <div className={`relative flex ${className}`} ref={containerRef}>
            <div
                ...
                className={`flex flex-1 relative z-10 flex-shrink-0 items-center space-x-3 cursor-pointer focus:outline-none text-left`}
            >
...
export default LocationBoookingInput;
